...
/* La partie "geometry" d'un geojson */
var poly = JSON.parse(fs.readFileSync('./1_drawing.json'));
console.log(poly.features[0].geometry);
...
var tilesRaw = cover.tiles(poly.features[0].geometry, limits);
/*
...
*/
var mymap = L.map('mapDiv').setView([45.73685954736049,
             -0.3515625,], 13);

var osmTiles = L.TileLayer.boundaryCanvas('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',{
    attribution : 'Map data © <a href="http://openstreetmap.org">OpenStreetMap</a> contributors',
    maxZoom : 13,
    boundary: poly.features[0].geometry
});

osmTiles.addTo(mymap);


},{"@mapbox/tile-cover":2,"fs":4}],2:[function(require,module,exports){
'use strict';
...
},{"@mapbox/tilebelt":3}],3:[function(require,module,exports){
'use strict';
