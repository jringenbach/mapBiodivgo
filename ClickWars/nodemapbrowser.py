...
def PyJs_anonymous_1_(require, module, exports, this, arguments, var=var):
    var = Scope({'require':require, 'arguments':arguments, 'module':module, 'exports':exports, 'this':this}, var)
    var.registers(['require', 'jsonToTiles', 'module', 'exports'])
    @Js
    def PyJsHoisted_jsonToTiles_(polygonjson, this, arguments, var=var):
        ...
        var.registers(['z', 'i', 'y', 'polygonjson', 'cover', 'tilesRaw', 'x', 'limits'])
...
def PyJs_anonymous_4_(require, module, exports, this, arguments, var=var):
    var = Scope({'require':require, 'arguments':arguments, 'module':module, 'exports':exports, 'this':this}, var)
    var.registers(['fromID', 'lineCover', 'mergeTiles', 'exports', 'module', 'tilebelt', 'compareTiles', 'appendHashTiles', 'getTiles', 'polygonCover', 'require', 'tileToFeature', 'toID'])
    @Js
    def PyJsHoisted_compareTiles_(a, b, this, arguments, var=var):
        var = Scope({'this':this, 'arguments':arguments, 'b':b, 'a':a}, var)
        var.registers(['b', 'a'])
    ...
    def PyJsHoisted_appendHashTiles_(hash, tiles, this, arguments, var=var):
        var = Scope({'tiles':tiles, 'arguments':arguments, 'this':this, 'hash':hash}, var)
        var.registers(['tiles', 'keys', 'i', 'hash'])
    ...
    def PyJsHoisted_getTiles_(geom, limits, this, arguments, var=var):
        var = Scope({'limits':limits, 'arguments':arguments, 'geom':geom, 'this':this}, var)
        var.registers(['tiles', 'i', 't', 'geom', 'len', 'maxZoom', 'tileHash', 'limits', 'tile', 'coords'])
    ...
    def PyJsHoisted_polygonCover_(tileHash, tileArray, geom, zoom, this, arguments, var=var):
        var = Scope({'arguments':arguments, 'tileArray':tileArray, 'geom':geom, 'zoom':zoom, 'tileHash':tileHash, 'this':this}, var)
        var.registers(['ring', 'tileArray', 'i', 'y', 'geom', 'zoom', 'j', 'len', 'intersections', 'tileHash', 'k', 'm', 'x', 'id'])
    ...
    def PyJsHoisted_lineCover_(tileHash, coords, maxZoom, ring, this, arguments, var=var):
        var = Scope({'ring':ring, 'maxZoom':maxZoom, 'tileHash':tileHash, 'arguments':arguments, 'this':this, 'coords':coords}, var)
        var.registers(['x1', 'i', 'y', 'y1', 'coords', 'ring', 'prevX', 'tMaxY', 'start', 'tdy', 'maxZoom', 'x0', 'stop', 'tMaxX', 'prevY', 'sx', 'sy', 'x', 'tdx', 'dy', 'y0', 'tileHash', 'dx'])
        pass
        #for JS loop
        var.put('i', Js(0.0))
    ...
    def PyJsHoisted_mergeTiles_(tileHash, tiles, limits, this, arguments, var=var):
        var = Scope({'tileHash':tileHash, 'tiles':tiles, 'limits':limits, 'arguments':arguments, 'this':this}, var)
        var.registers(['tiles', 'z', 'i', 't', 'id3', 'parentTile', 'parentTileHash', 'tileHash', 'id2', 'limits', 'mergedTiles', 'id4', 'parentTiles'])
    ...
    def PyJsHoisted_toID_(x, y, z, this, arguments, var=var):
        var = Scope({'x':x, 'z':z, 'arguments':arguments, 'y':y, 'this':this}, var)
        var.registers(['x', 'z', 'y', 'dim'])
        var.put('dim', (Js(2.0)*(Js(1.0)<<var.get('z'))))
...
def PyJs_anonymous_13_(require, module, exports, this, arguments, var=var):
    var = Scope({'require':require, 'arguments':arguments, 'module':module, 'exports':exports, 'this':this}, var)
    var.registers(['r2d', 'getChildren', 'tilesEqual', 'getBboxZoom', 'exports', 'tileToBBOX', 'hasTile', 'module', 'bboxToTile', 'tile2lat', 'tile2lon', 'pointToTile', 'quadkeyToTile', 'getSiblings', 'require', 'hasSiblings', 'tileToQuadkey', 'tileToGeoJSON', 'getParent', 'd2r', 'pointToTileFraction'])
    @Js
    def PyJsHoisted_pointToTile_(lon, lat, z, this, arguments, var=var):
        var = Scope({'z':z, 'arguments':arguments, 'lat':lat, 'lon':lon, 'this':this}, var)
        var.registers(['z', 'tile', 'lat', 'lon'])
    ...
    def PyJsHoisted_getChildren_(tile, this, arguments, var=var):
        var = Scope({'arguments':arguments, 'tile':tile, 'this':this}, var)
        var.registers(['tile'])
    ...
    def PyJsHoisted_tilesEqual_(tile1, tile2, this, arguments, var=var):
        var = Scope({'arguments':arguments, 'tile2':tile2, 'tile1':tile1, 'this':this}, var)
    ...
    def PyJsHoisted_quadkeyToTile_(quadkey, this, arguments, var=var):
        ...
        var.registers(['z', 'i', 'y', 'q', 'mask', 'quadkey', 'x'])
        var.put('x', Js(0.0))
        var.put('y', Js(0.0))
    ...
    def PyJsHoisted_hasTile_(tiles, tile, this, arguments, var=var):
        var = Scope({'arguments':arguments, 'tiles':tiles, 'tile':tile, 'this':this}, var)
        var.registers(['tiles', 'tile', 'i'])
        #for JS loop
        var.put('i', Js(0.0))
        while (var.get('i')<var.get('tiles').get('length')):
            try:
    ...
    def PyJsHoisted_bboxToTile_(bboxCoords, this, arguments, var=var):
        ...
        var.registers(['z', 'y', 'bbox', 'bboxCoords', 'x', 'min', 'max'])
    ...
    def PyJsHoisted_tile2lat_(y, z, this, arguments, var=var):
        var = Scope({'z':z, 'arguments':arguments, 'y':y, 'this':this}, var)
        var.registers(['n', 'z', 'y'])
    ...
    def PyJsHoisted_tile2lon_(x, z, this, arguments, var=var):
        var = Scope({'x':x, 'z':z, 'arguments':arguments, 'this':this}, var)
        var.registers(['x', 'z'])
    ...
    def PyJsHoisted_getBboxZoom_(bbox, this, arguments, var=var):
        var = Scope({'arguments':arguments, 'bbox':bbox, 'this':this}, var)
        var.registers(['mask', 'z', 'MAX_ZOOM', 'bbox'])
    ...
    def PyJsHoisted_hasSiblings_(tile, tiles, this, arguments, var=var):
        var = Scope({'arguments':arguments, 'tiles':tiles, 'tile':tile, 'this':this}, var)
        var.registers(['tiles', 'tile', 'i', 'siblings'])
    ...
    def PyJsHoisted_tileToQuadkey_(tile, this, arguments, var=var):
        var = Scope({'arguments':arguments, 'tile':tile, 'this':this}, var)
        var.registers(['mask', 'z', 'tile', 'b', 'index'])
        var.put('index', Js(''))
        #for JS loop
    ...
    def PyJsHoisted_pointToTileFraction_(lon, lat, z, this, arguments, var=var):
        var = Scope({'z':z, 'arguments':arguments, 'lat':lat, 'lon':lon, 'this':this}, var)
        var.registers(['z', 'lat', 'y', 'lon', 'z2', 'x', 'sin'])
...
def PyJs_e_18_(t, n, r, this, arguments, var=var):
    var = Scope({'n':n, 'arguments':arguments, 'e':PyJs_e_18_, 't':t, 'r':r, 'this':this}, var)
    var.registers(['n', 'i', 't', 's', 'o', 'r'])
    @Js
    def PyJsHoisted_s_(o, u, this, arguments, var=var):
        var = Scope({'u':u, 'o':o, 'arguments':arguments, 'this':this}, var)
        var.registers(['f', 'l', 'o', 'u', 'a'])
        if var.get('n').get(var.get('o')).neg():
            ...
            def PyJs_anonymous_21_(e, this, arguments, var=var):
                var = Scope({'arguments':arguments, 'e':e, 'this':this}, var)
                var.registers(['n', 'e'])
